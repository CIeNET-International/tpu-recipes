...
From your workload logs, you should see step time logs like the following, with the training progresses:
```
...
Workload configuration details can be found [here](https://github.com/AI-Hypercomputer/maxtext/blob/main/benchmarks/maxtext_v5p_model_configs.py) in MaxText GitHub repo. Look for the configuration `llama3_1_405b_8192_v5p_1024`.
